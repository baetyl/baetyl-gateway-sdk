module github.com/baetyl/baetyl-gateway-sdk/demo/httpin

go 1.20

replace (
	github.com/baetyl/baetyl-gateway-sdk/sdk/golang => /Users/zhaoxin26/go/src/github.com/baetyl/baetyl-gateway-sdk/sdk/golang
)
